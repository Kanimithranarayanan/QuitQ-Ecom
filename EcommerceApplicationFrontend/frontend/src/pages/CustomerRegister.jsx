...
const CustomerRegister = () => {
    ...
    const registerApi = "http://localhost:8088/api/customer/add"
    const navigate = useNavigate()

    const onRegister = async (e) => {
        e.preventDefault()
        let body = { 'name': name, 'gender': gender, 'contactNumber': contactNumber,
    ...
    return (
        <div style={{ background:'linear-gradient(135deg,#eff6ff,#f0f9ff)', minHeight:'100vh', display:'flex', alignItems:'center', justifyContent:'center', padding:'2rem 1rem' }}>
            <div style={{ width:'100%', maxWidth:'600px' }}>
                <div className="text-center mb-4">
                    <span className="quitq-logo logo-public" style={{ fontSize:'1.1rem', padding:'7px 22px' }}>QuitQ</span>
                    <p className="text-muted mt-2 small">Create your customer account</p>
                </div>
                <div className="card border-0" style={{ borderRadius:'1rem', boxShadow:'0 4px 24px rgba(59,130,246,0.12)', border:'1.5px solid #bfdbfe' }}>
                    <div className="card-body p-4">
                        <h5 className="fw-bold mb-4" style={{ color:'#0f2942' }}>Customer Registration</h5>
                        <form onSubmit={(e) => onRegister(e)}>
                            ...
                            <div className="mb-3">
                                ...
                                <textarea className="form-control" rows="2" style={{ borderColor:'#bfdbfe', borderRadius:'.5rem' }}
                            ...
                            <button type="submit" className="btn w-100 fw-bold text-white mb-2"
                                ...
                                <i className="bi bi-person-plus me-2"></i>Register as Customer
                            </button>
                        </form>
